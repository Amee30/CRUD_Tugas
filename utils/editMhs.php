...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $sql = "SELECT * FROM mahasiswamember WHERE id = $getId";
    ...
    $getAddress = $_POST['alamat'];
        ...
        $sql = "UPDATE mahasiswamember SET nama = '$getUser', nim = '$getNim', alamat = '$getAddress' WHERE id = '$getId'";
        $result = $koneksi -> query($sql);
        header("location:../table/dataMhs.php");
    ...
    <div class="container">
        ...
        <form class="need-validation" method="post">
            ...
            <div class="form-group was-validated">
                ...
                <input class="form-control" type="text" id="nim" name="nim"  value="<?php echo $getNim; ?>" required>
            </div>
